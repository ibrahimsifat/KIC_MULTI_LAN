...
const Footer = () => {
    ...
    <div className="left mx-auto">
            <p className='textred font-semibold text-xl monsterratFont   pb-2'>Contact Information</p>
            <p className='border-b-2 border-red-600 border-fuchsia-600 w-32'></p>
            <p className='font-semibold text-white mt-4 mb-2'>Phone <span className='textred '>+966505353820</span></p>
            <p className='font-semibold text-white mt-4 mb-2'>Email <span className='textred '>atif@kicadv.com</span></p>
         ...
         <button className=' hover:bg-red-800 duration-500 absolute lg:left-36 left-20 sm:left-24 md:left-28  md:-bottom-1 bottom-7 bgred py-1 px-8 rounded-md font-semibold text-white'>Send Massage</button>
         </div>
    </div>
