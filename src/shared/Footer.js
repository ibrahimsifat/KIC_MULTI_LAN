...
<span className='border-b-2 border-red-600 block mx-auto  border-fuchsia-600 w-16'></span>
        ...
        <div className='hover:text-red-500 text-left '>
                <NavLink className='ml-0 text-white no-underline font-bold  py-1 block' to='/aboutus'>{t('Navigation_About')}</NavLink>
                ...
                <div>
                    ...
                    <div className='text-white text-left mr-4'>
                        <NavLink className='text-white  mt-2  no-underline font-bold  py-1 block'  to='/allclientsrecognition'>{t('Navigation_recognition')}</NavLink>
