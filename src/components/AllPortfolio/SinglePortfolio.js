  ...
  return (
    <div className=" mx-auto  img-hover duration-700 border border-white ">
      <div className="transition duration-300 ease-in-out xl:mb-0 lg:mb-0 md:mb-0 mb-6 cursor-pointer group">
        <Zoom>
          <div
            className="overflow-hidden relative item-zoom"
            onClick={() => handleClientDetails(_id)}
          >
            <img
              className="w-full transform transition hover:scale-105 duration-300 ease-in-out "
              src={img}
              alt=""
            />
            ...
            <div className="absolute bottom-0 duration-700 h-full w-full flex justify-center items-center bg-gray-900 group-hover:bg-opacity-90   transition duration-500 ease-in-out opacity-0 group-hover:opacity-100 ">
              <div className="flex flex-col  justify-center items-center ">
                ...
                <i
                  ...
                  type="button"
                >
                  <h1 className=" px-3 py-1 text-white hover:scale transition transform duration-500 rounded-full text-black">
