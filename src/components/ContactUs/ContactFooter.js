...
const ContactFooter = () => {
  ...
  const handleFaceBook = () => {
    window.location.href =
      "https://www.facebook.com/KIC-Printing-Advertising-333673783382403/";
  };
  ...
  return (
    <div className="contactFooterbg">
      <div className="">
        <div className="container mx-auto flex flex-col py-20 justify-center items-center  ">
          <div className="mt-12 grid lg:grid-cols-3 md:grid-cols-2 justify-around items-center ">
            <p className="text-xl lg:m-10  text-white m-3">
              <i className="fas fa-phone bg-indigo-600 mx-2 px-3 py-2 rounded-full hover:bg-indigo-800 hover:text-white duration-500 text-sm">
                {" "}
                {phoneIcon}
              </i>
            ...
            <p className="text-xl lg:m-10 m-3  text-white">
              ...
              <span className="text-white  ">atif@kicadv.com</span>
            </p>
          ...
          <div className="mt-12 sm:flex justify-between  items-center ">
            ...
            >
              <span className=" text-white bg-indigo-600 mx-2 px-3 py-2 rounded-full hover:bg-indigo-800 hover:text-white duration-500 text-sm">
                {faceBookIcon}
              </span>
              <span className=" text-white">KICADV</span>
            </p>

            <p onClick={handleInstagram} className=" text-xl mx-4 md:mx-16">
              <span className="  text-white bg-indigo-600 mx-2 px-3 py-2 rounded-full hover:bg-indigo-800 hover:text-white duration-500 text-sm ">
                {instagramIcon}
              </span>
