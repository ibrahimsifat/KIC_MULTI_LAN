...
const Philosophy = () => {
  ...
  const { t } = useTranslation()
    ...
    return (
      ...
      <div className="container mx-auto mt-10 my-20 lg:px-20">
		<div className="relative w-full my-4 lg:w-9/12 mr-auto rounded-2xl shadow-xl">
			<img alt="Card" src={Img} className="max-w-full rounded-lg "/>
        </div>
		<div className="relative w-full lg:-mt-96 lg:w-3/6 p-8 ml-auto bg-blue-800 rounded-xl z-50">
		    <div className="flex flex-col text-white">
                ...
                <p className="text-white md:text-xl my-4 px-2">
