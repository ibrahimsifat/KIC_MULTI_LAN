        ...
        <div className='px-8 md:px-16 '>
            ...
            <div className="  flex justify-center items-center lg-pt-0 pt-8">
             <div className={!IsArabic?"container mx-auto pt-52 monsterratFont md:mr-44 px-5":"container absolute top-60 md:right-32  px-5"}>
                ...
                <p className='uppercase font-extrabold  md:text-white  text-blue-600  lg:text-5xl md:text-4xl sm:text-4xl text-4xl '>{t('home_portfolio_first')}</p>
                <p className='uppercase font-extrabold md:text-white  text-blue-600 lg:text-5xl  md:text-4xl sm:text-4xl text-4xl '>{t('home_portfolio_second')}</p>
