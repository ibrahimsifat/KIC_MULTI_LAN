          ...
          <div className='px-8 md:px-16 '>
            ...
            <div className="right  flex justify-center items-center lg-pt-0 pt-8">
              <div className="container mx-auto pt-52 monsterratFont md:pl-32 px-5">
                ...
                <p className='uppercase font-extrabold text-white  lg:text-5xl md:text-4xl sm:text-4xl text-3xl '>download</p>
                <p className='uppercase font-extrabold text-white  lg:text-5xl  md:text-4xl sm:text-4xl text-3xl '>our</p>
