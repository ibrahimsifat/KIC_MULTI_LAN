...
const Testimonial=({img})=>{
    return(
         <div>
                        ...
                        <div className="group  bg-white relative flex flex-col items-center hover:bg-indigo-700 cursor-pointer shadow-md md:p-12 p-6 mx-4">
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            <img src={img} alt="profile pictre " className="w-12 h-12 rounded-full" />
                            <p className="text-base font-semibold leading-4 my-2 text-gray-800">Tom Koch</p>
                            <p className="text-sm leading-4 text-center text-gray-600">Founder</p>
                        </div>
                    </div>
    )
}
