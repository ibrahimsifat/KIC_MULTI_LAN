...
const ServiceDownloadPortfolio = () => {
    ...
    return (
        <div className='downloadPortfolio_bg my-4 relative'>
           ...
           <a href='../Profile.pdf' download="KIC Portfolio" className=' fromLeft  tracking-tighter font-extrabold uppercase py-9 text-white text-md sm:text-2xl border-line lg:text-4xl mb-6 lg:mb-8 no-underline md:mx-16 mx-2'>
