        ...
        <div className="VisionsBanner">
          <div className="   flex justify-center flex-col items-center pt-44 ">
            ...
            <div className="text-black font-semibold text-xl mt-2 flex">
              ...
              <span className=" ">{t("vision_one")}</span>
            </div>
          </div>
        </div>
      </div>
      {!IsArabic ? (
        <div className="grid sm:grid-cols-2 justify-center md:w-10/12 mx-auto w-11/12 items-center">
          <div>
            <img src={VIsionImg} alt="" className="sm:border-r w-full" />
          </div>
        ...
        <div className="grid sm:grid-cols-2 justify-center md:w-10/12 mx-auto w-11/12 items-center">
          <MisionTimeline></MisionTimeline>
          <div>
            <img src={VIsionImg2} alt="" className="sm:border-r w-full" />
          </div>
        </div>
      )}
    </div>
