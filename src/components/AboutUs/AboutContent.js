...
const AboutContent = () => {
    ...
    return (
        <div className=' about_content flex justify-start items-center'>
            <div className={!IsArabic?'container  monsterratFont md:px-10 mx-4 md:mx-16 md:pr-20  md:mt-0 mt-4 ml-6 md:w-6/12 ':" mx-auto arabic-font-1  md:mx-16 mx-4 container md:mt-0  mt-4  md:w-6/12 " }>
