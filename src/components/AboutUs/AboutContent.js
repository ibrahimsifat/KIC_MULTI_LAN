...
const AboutContent = () => {
    ...
    return (
        ...
        data-aos-duration="1000" className={!IsArabic?'w-full  monsterratFont md:px-10 mx-4 md:mx-16 md:pr-20  md:mt-0 mt-4 ml-6 md:w-7/12 ':"  mx-auto arabic-font-1  px-4 w-full md:mt-0  mt-4 md:w-10/12 " }>
